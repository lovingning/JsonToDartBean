...
public enum DataType {
    ...
    Data_Type_Boolean("bool"), Data_Type_Int("int"), Data_Type_Double("double"),
    Data_Type_long("int"), Data_Type_String("String"), Data_type_Object("Object"), Data_Type_Array("array");
    ...
    public static DataType typeOfString(String type) {
        if ("boolean".equals(type) || "Boolean".equals(type) || "bool".equals(type)) {
